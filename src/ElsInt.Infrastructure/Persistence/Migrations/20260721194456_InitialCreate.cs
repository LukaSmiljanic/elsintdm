    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InstallationTeams", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CoolingCapacityKw = table.Column<decimal>(type: "decimal(8,2)", precision: 8, scale: 2, nullable: false),
                    HeatingCapacityKw = table.Column<decimal>(type: "decimal(8,2)", precision: 8, scale: 2, nullable: false),
                    CoolingBtu = table.Column<int>(type: "int", nullable: false),
                    HeatingBtu = table.Column<int>(type: "int", nullable: false),
                    EnergyClassCooling = table.Column<int>(type: "int", nullable: false),
                    EnergyClassHeating = table.Column<int>(type: "int", nullable: false),
                    IsInverter = table.Column<bool>(type: "bit", nullable: false),
                    HasWifi = table.Column<bool>(type: "bit", nullable: false),
                    NoiseLevelDb = table.Column<decimal>(type: "decimal(6,2)", precision: 6, scale: 2, nullable: false),
                    CoverageAreaSqm = table.Column<decimal>(type: "decimal(8,2)", precision: 8, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InstallationFee = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InstallationRequests_Orders_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateTable(
                name: "InstallationAppointments",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    InstallationRequestId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    InstallationTeamId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InstallationAppointments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InstallationAppointments_InstallationRequests_InstallationRequestId",
                        column: x => x.InstallationRequestId,
                        principalTable: "InstallationRequests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InstallationAppointments_InstallationTeams_InstallationTeamId",
                        column: x => x.InstallationTeamId,
                        principalTable: "InstallationTeams",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ConsentRecords_CustomerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InstallationAppointments_InstallationRequestId",
                table: "InstallationAppointments",
                column: "InstallationRequestId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_InstallationAppointments_InstallationTeamId",
                table: "InstallationAppointments",
                column: "InstallationTeamId");

            migrationBuilder.CreateIndex(
                name: "IX_InstallationRequests_OrderId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_CoolingCapacityKw",
                table: "Products",
                column: "CoolingCapacityKw");

            migrationBuilder.CreateIndex(
                name: "IX_Products_CoverageAreaSqm",
                table: "Products",
                column: "CoverageAreaSqm");

            migrationBuilder.CreateIndex(
                name: "IX_Products_EnergyClassCooling",
                table: "Products",
                column: "EnergyClassCooling");

            migrationBuilder.CreateIndex(
                name: "IX_Products_HasWifi",
                table: "Products",
                column: "HasWifi");

            migrationBuilder.CreateIndex(
                name: "IX_Products_IsActive_CategoryId_BrandId_Price",
                table: "Products",
                columns: new[] { "IsActive", "CategoryId", "BrandId", "Price" });

            migrationBuilder.CreateIndex(
                name: "IX_Products_IsInverter",
                table: "Products",
                column: "IsInverter");
